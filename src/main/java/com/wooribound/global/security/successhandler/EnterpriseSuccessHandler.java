...
public class EnterpriseSuccessHandler extends SimpleUrlAuthenticationSuccessHandler {
  ...
  public void onAuthenticationSuccess(HttpServletRequest request, HttpServletResponse response, Authentication authentication)
    ...
    String userId = enterpriseUserDetail.getUserId();
    String username = enterpriseUserDetail.getUsername();
    // stream()을 사용해 권한 하나만 꺼내기
    String role = enterpriseUserDetail.getAuthorities().stream()
        .findFirst()
