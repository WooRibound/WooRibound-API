...
-- Wb_User 데이터
INSERT INTO wb_user (user_id, genderType, job_point, birth, created_at, data_sharing_consent, addr_city, addr_province, name, phone, email, exjob_chk, interest_chk, job_interest, is_deleted) VALUES ('USER001', 'M', 10, STR_TO_DATE('1985-05-20 00:00:00', '%Y-%m-%d %H:%i:%s'), NOW(), 'Y', '서울', '서울시', '김철수', '010-1234-5678', 'kim@example.com', 'Y', 'Y', 'Y', 'N');
INSERT INTO wb_user (user_id, genderType, job_point, birth, created_at, data_sharing_consent, addr_city, addr_province, name, phone, email, exjob_chk, interest_chk, job_interest, is_deleted) VALUES ('USER002', 'F', 5, STR_TO_DATE('1990-03-15 00:00:00', '%Y-%m-%d %H:%i:%s'), NOW(), 'Y', '부산', '부산시', '이영희', '010-9876-5432', 'lee@example.com', 'Y', 'Y', 'N', 'N');
INSERT INTO wb_user (user_id, genderType, job_point, birth, created_at, data_sharing_consent, addr_city, addr_province, name, phone, email, exjob_chk, interest_chk, job_interest, is_deleted) VALUES ('USER003', 'M', 15, STR_TO_DATE('1988-08-05 00:00:00', '%Y-%m-%d %H:%i:%s'), NOW(), 'Y', '성남', '경기도', '최민수', '010-3456-7890', 'choi@example.com', 'N', 'Y', 'Y', 'N');
INSERT INTO wb_user (user_id, genderType, job_point, birth, created_at, data_sharing_consent, addr_city, addr_province, name, phone, email, exjob_chk, interest_chk, job_interest, is_deleted) VALUES ('USER004', 'F', 25, STR_TO_DATE('1992-11-10 00:00:00', '%Y-%m-%d %H:%i:%s'), NOW(), 'N', '대전', '대전시', '박지영', '010-1234-5679', 'park@example.com', 'N', 'N', 'N', 'N');
INSERT INTO wb_user (user_id, genderType, job_point, birth, created_at, data_sharing_consent, addr_city, addr_province, name, phone, email, exjob_chk, interest_chk, job_interest, is_deleted) VALUES ('USER005', 'M', 10, STR_TO_DATE('1983-09-12 00:00:00', '%Y-%m-%d %H:%i:%s'), NOW(), 'Y', '대구', '대구시', '장희원', '010-1234-5680', 'jang@example.com', 'Y', 'Y', 'N', 'N');
INSERT INTO wb_user (user_id, genderType, job_point, birth, created_at, data_sharing_consent, addr_city, addr_province, name, phone, email, exjob_chk, interest_chk, job_interest, is_deleted) VALUES ('USER006', 'F', 8, STR_TO_DATE('1987-02-10 00:00:00', '%Y-%m-%d %H:%i:%s'), NOW(), 'Y', '광주', '광주시', '홍길순', '010-2345-6789', 'hong@example.com', 'Y', 'N', 'Y', 'N');
INSERT INTO wb_user (user_id, genderType, job_point, birth, created_at, data_sharing_consent, addr_city, addr_province, name, phone, email, exjob_chk, interest_chk, job_interest, is_deleted) VALUES ('USER007', 'M', 20, STR_TO_DATE('1982-11-22 00:00:00', '%Y-%m-%d %H:%i:%s'), NOW(), 'N', '인천', '인천시', '최동현', '010-3456-7891', 'choid@example.com', 'N', 'Y', 'Y', 'N');
INSERT INTO wb_user (user_id, genderType, job_point, birth, created_at, data_sharing_consent, addr_city, addr_province, name, phone, email, exjob_chk, interest_chk, job_interest, is_deleted) VALUES ('USER008', 'F', 12, STR_TO_DATE('1995-06-30 00:00:00', '%Y-%m-%d %H:%i:%s'), NOW(), 'Y', '대전', '대전시', '고수정', '010-4567-8910', 'go@example.com', 'Y', 'Y', 'N', 'N');
INSERT INTO wb_user (user_id, genderType, job_point, birth, created_at, data_sharing_consent, addr_city, addr_province, name, phone, email, exjob_chk, interest_chk, job_interest, is_deleted) VALUES ('USER009', 'M', 18, STR_TO_DATE('1989-04-25 00:00:00', '%Y-%m-%d %H:%i:%s'), NOW(), 'N', '울산', '울산시', '이재훈', '010-5678-9101', 'leej@example.com', 'Y', 'N', 'Y', 'N');
INSERT INTO wb_user (user_id, genderType, job_point, birth, created_at, data_sharing_consent, addr_city, addr_province, name, phone, email, exjob_chk, interest_chk, job_interest, is_deleted) VALUES ('USER010', 'F', 30, STR_TO_DATE('1990-09-17 00:00:00', '%Y-%m-%d %H:%i:%s'), NOW(), 'Y', '수원', '경기도', '김하나', '010-6789-0123', 'kima@example.com', 'N', 'Y', 'N', 'N');
INSERT INTO wb_user (user_id, genderType, job_point, birth, created_at, data_sharing_consent, addr_city, addr_province, name, phone, email, exjob_chk, interest_chk, job_interest, is_deleted) VALUES ('USER011', 'M', 5, STR_TO_DATE('1993-01-05 00:00:00', '%Y-%m-%d %H:%i:%s'), NOW(), 'N', '서울', '서울시', '박진수', '010-7890-1234', 'parkj@example.com', 'Y', 'N', 'Y', 'N');
INSERT INTO wb_user (user_id, genderType, job_point, birth, created_at, data_sharing_consent, addr_city, addr_province, name, phone, email, exjob_chk, interest_chk, job_interest, is_deleted) VALUES ('USER012', 'F', 22, STR_TO_DATE('1991-07-12 00:00:00', '%Y-%m-%d %H:%i:%s'), NOW(), 'Y', '대구', '대구시', '윤소희', '010-8901-2345', 'yoon@example.com', 'Y', 'Y', 'N', 'N');
INSERT INTO wb_user (user_id, genderType, job_point, birth, created_at, data_sharing_consent, addr_city, addr_province, name, phone, email, exjob_chk, interest_chk, job_interest, is_deleted) VALUES ('USER013', 'M', 16, STR_TO_DATE('1986-08-19 00:00:00', '%Y-%m-%d %H:%i:%s'), NOW(), 'N', '부산', '부산시', '이강민', '010-9012-3456', 'leek@example.com', 'N', 'Y', 'Y', 'N');
INSERT INTO wb_user (user_id, genderType, job_point, birth, created_at, data_sharing_consent, addr_city, addr_province, name, phone, email, exjob_chk, interest_chk, job_interest, is_deleted) VALUES ('USER014', 'F', 9, STR_TO_DATE('1994-03-22 00:00:00', '%Y-%m-%d %H:%i:%s'), NOW(), 'Y', '광주', '광주시', '김은지', '010-0123-4567', 'kime@example.com', 'Y', 'N', 'N', 'N');
INSERT INTO wb_user (user_id, genderType, job_point, birth, created_at, data_sharing_consent, addr_city, addr_province, name, phone, email, exjob_chk, interest_chk, job_interest, is_deleted) VALUES ('USER015', 'M', 14, STR_TO_DATE('1984-12-10 00:00:00', '%Y-%m-%d %H:%i:%s'), NOW(), 'N', '수원', '경기도', '최영수', '010-2345-6789', 'choiy@example.com', 'N', 'N', 'Y', 'N');
INSERT INTO wb_user (user_id, genderType, job_point, birth, created_at, data_sharing_consent, addr_city, addr_province, name, phone, email, exjob_chk, interest_chk, job_interest, is_deleted) VALUES ('USER016', 'M', 12, STR_TO_DATE('1991-04-14 00:00:00', '%Y-%m-%d %H:%i:%s'), NOW(), 'Y', '서울', '서울시', '이승민', '010-1111-2222', 'seungmin@example.com', 'Y', 'Y', 'Y', 'N');
INSERT INTO wb_user (user_id, genderType, job_point, birth, created_at, data_sharing_consent, addr_city, addr_province, name, phone, email, exjob_chk, interest_chk, job_interest, is_deleted) VALUES ('USER017', 'F', 20, STR_TO_DATE('1988-02-18 00:00:00', '%Y-%m-%d %H:%i:%s'), NOW(), 'Y', '부산', '부산시', '김지연', '010-3333-4444', 'jiyun@example.com', 'Y', 'Y', 'Y', 'N');
INSERT INTO wb_user (user_id, genderType, job_point, birth, created_at, data_sharing_consent, addr_city, addr_province, name, phone, email, exjob_chk, interest_chk, job_interest, is_deleted) VALUES ('USER018', 'M', 18, STR_TO_DATE('1985-07-12 00:00:00', '%Y-%m-%d %H:%i:%s'), NOW(), 'Y', '광주', '광주시', '박현우', '010-5555-6666', 'hyunwoo@example.com', 'Y', 'Y', 'Y', 'N');
INSERT INTO wb_user (user_id, genderType, job_point, birth, created_at, data_sharing_consent, addr_city, addr_province, name, phone, email, exjob_chk, interest_chk, job_interest, is_deleted) VALUES ('USER019', 'F', 25, STR_TO_DATE('1992-11-23 00:00:00', '%Y-%m-%d %H:%i:%s'), NOW(), 'Y', '대구', '대구시', '정수진', '010-7777-8888', 'sujin@example.com', 'Y', 'Y', 'Y', 'N');
INSERT INTO wb_user (user_id, genderType, job_point, birth, created_at, data_sharing_consent, addr_city, addr_province, name, phone, email, exjob_chk, interest_chk, job_interest, is_deleted) VALUES ('USER020', 'M', 15, STR_TO_DATE('1983-03-30 00:00:00', '%Y-%m-%d %H:%i:%s'), NOW(), 'Y', '울산', '울산시', '최기혁', '010-9999-1010', 'kihyuk@example.com', 'Y', 'Y', 'Y', 'N');
INSERT INTO wb_user (user_id, genderType, job_point, birth, created_at, data_sharing_consent, addr_city, addr_province, name, phone, email, exjob_chk, interest_chk, job_interest, is_deleted) VALUES ('USER021', 'F', 22, STR_TO_DATE('1990-06-15 00:00:00', '%Y-%m-%d %H:%i:%s'), NOW(), 'Y', '인천', '인천시', '조은혜', '010-1212-3434', 'eunhye@example.com', 'Y', 'Y', 'Y', 'N');
INSERT INTO wb_user (user_id, genderType, job_point, birth, created_at, data_sharing_consent, addr_city, addr_province, name, phone, email, exjob_chk, interest_chk, job_interest, is_deleted) VALUES ('USER022', 'M', 10, STR_TO_DATE('1987-10-02 00:00:00', '%Y-%m-%d %H:%i:%s'), NOW(), 'Y', '수원', '경기도', '임동혁', '010-1414-5656', 'donghyuk@example.com', 'Y', 'Y', 'Y', 'N');
INSERT INTO wb_user (user_id, genderType, job_point, birth, created_at, data_sharing_consent, addr_city, addr_province, name, phone, email, exjob_chk, interest_chk, job_interest, is_deleted) VALUES ('USER023', 'F', 30, STR_TO_DATE('1995-01-28 00:00:00', '%Y-%m-%d %H:%i:%s'), NOW(), 'Y', '성남', '경기도', '한지우', '010-1616-7878', 'jiwoo@example.com', 'Y', 'Y', 'Y', 'N');
INSERT INTO wb_user (user_id, genderType, job_point, birth, created_at, data_sharing_consent, addr_city, addr_province, name, phone, email, exjob_chk, interest_chk, job_interest, is_deleted) VALUES ('USER024', 'M', 13, STR_TO_DATE('1989-12-09 00:00:00', '%Y-%m-%d %H:%i:%s'), NOW(), 'Y', '대전', '대전시', '유현수', '010-1818-9090', 'hyunsu@example.com', 'Y', 'Y', 'Y', 'N');
INSERT INTO wb_user (user_id, genderType, job_point, birth, created_at, data_sharing_consent, addr_city, addr_province, name, phone, email, exjob_chk, interest_chk, job_interest, is_deleted) VALUES ('USER025', 'F', 27, STR_TO_DATE('1993-09-19 00:00:00', '%Y-%m-%d %H:%i:%s'), NOW(), 'Y', '제주', '제주시', '송하늘', '010-2020-1212', 'haneul@example.com', 'Y', 'Y', 'Y', 'N');
...
(15, '기타', '나의 손끝에서 시작된 새로운 직업 이야기',
'1. 작은 공방에서 수공예품을 만들고, 고객들에게 디자인 서비스를 제공하는 역할을 맡았습니다.\n
2. 손재주를 활용해 제작한 작품들이 SNS를 통해 인기를 얻어 많은 주문을 받았고, 고객들로부터 긍정적인 피드백을 받았습니다. 예를 들어, 맞춤 주문을 받아 손으로 직접 제작한 고객 맞춤 디자인 제품들이 많은 사랑을 받았습니다.\n
3. 손재주를 활용하여 수공예품을 만들고, 디자인 서비스를 제공하는 일을 하고 있습니다. SNS를 통해 작품을 홍보하고 판매하는 과정에서 커뮤니티에서 인기를 얻었습니다.\n
4. 어릴 적부터 손재주가 좋아서 수공예품을 만들고 친구들에게 선물하는 것에서 시작해, SNS를 통해 작품을 홍보하고 판매하는 작은 공방을 운영하고 있습니다.\n
5. 손재주를 활용하여 수공예품을 만들고, 디자인 서비스를 제공하는 일을 하고 있습니다. 관심이 있는 분들에게는 자신의 취미와 특기를 직업으로 만들어가는 과정에서 필요한 역량과 경험을 쌓을 수 있는 영감을 줄 수 있습니다.\n\n
**추가 정보:**\n
1. 창작 디자이너나 수공예 작가로 활동하기 위해서는 창의력과 손재주가 필요합니다.\n
2. 관련 전문 교육이나 워크샵을 통해 기술을 향상시킬 수 있습니다.',
STR_TO_DATE('2024-12-04', '%Y-%m-%d'), 'USER017');
